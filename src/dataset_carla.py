...
def get_lane_ids_in_xy_bbox(x, y, city_name, query_search_range_manhattan):
    """
...
def get_lane_segment_centerline(lane_id, city_name):
    """
    ...
    """
    lane_segment_centerline = None
    return lane_segment_centerline

def get_lane_segment_polygon(lane_id, city_name):
    """
    ...
    """
    lane_segment_polygon = None
    return lane_segment_polygon
